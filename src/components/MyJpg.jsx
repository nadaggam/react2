...
export function MyJpg() {
  return (
    <div className='container rounded' style={{width:"100vw" ,marginTop:"30px"}}>
       <h1 style={{textShadow: "2px 2px 10px #884A39" , color:"#884A39",paddingTop:"20px"}}>The power of Accesories</h1> 
