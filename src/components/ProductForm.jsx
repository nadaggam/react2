...
let formOperation = (e) => {
 ...
 let OperationHandler = (e) => {
  ...
  <label for="productimg" className="form-label" >Product image  </label>
   <input onChange={OperationHandler} type="text" className="form-control" defaultValue={product.productimg} name="productimg" placeholder="Enter url for image" accept="image/*"/>
   </div>
   <div className="mb-3">
 ...
 type="text" className="form-control" name="productName" placeholder="Enter product name"/>
  ...
  <div className="mb-3">
    ...
    <input onChange={OperationHandler} defaultValue={product.productPrice} type="number" className="form-control" name="productPrice" placeholder="Enter price"/>
  </div>
  <div className="mb-3">
